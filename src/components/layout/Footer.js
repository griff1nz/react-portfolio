...
function Footer() {
    return <footer>
        <div className='items-center flex justify-between p-2'>
            <div>
                <p className='text-center text-white mx-4 text-sm sm:text-base'>©2024 Zion Griffin. <Link to='https://github.com/griff1nz/react-portfolio' target='_blank' className='underline'>View the code</Link></p>
            </div>
