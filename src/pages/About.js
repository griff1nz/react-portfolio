    ...
    return <div className='height85 my-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 place-items-center items-start'>
            <AboutCard>
                ...
                <p className='text-white text-xl my-2'>Embarking on my journey as a rising web developer, I am enthusiastic about creating impactful digital experiences. Eager to contribute and learn, I bring a fresh perspective, a passion for coding, and a dedication to mastering the art of web development.</p>
            </AboutCard>
            <AboutCard>
