    ...
    transition={{ duration: 0.75, ease: 'easeOut' }} className='height85 my-4'>
        ...
        {twoDivs && <div className='flex'>
            <div className='grid grid-cols-1 place-items-center items-start'>
                ...
                <AboutCard>
                    <p className='text-color text-3xl  font-semibold mt-6'>Passion for Coding</p>
                ...
                <AboutCard>
                    <p className='text-color text-3xl  font-semibold mt-6'>Learning Journey</p>
            ...
            <div className='grid grid-cols-1 place-items-center items-start'>
                    <AboutCard>
                        <p className='text-color text-3xl  font-semibold mt-6'>Educational Background</p>
                ...
                <AboutCard>
                    <p className='text-color text-3xl  font-semibold mt-6'>Beyond the Screen</p>
                ...
                <AboutCard>
                    <p className='text-color text-3xl  font-semibold mt-6'>Connect with Me</p>
