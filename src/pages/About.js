...
function About() {
    return <div className='height85 my-4'>
        <h1 className='text-white text-center text-5xl font-semibold mb-4'>About Me</h1>
        <Card>
            ...
            <p className='text-white text-3xl underline font-semibold'>Hello, my name is Zion Griffin.</p>
            <p className='text-white text-xl my-2'>Embarking on my journey as a budding web developer, I am enthusiastic about creating impactful digital experiences. Eager to contribute and learn, I bring a fresh perspective, a passion for coding, and a dedication to mastering the art of web development.</p>
            ...
            <p className='text-white text-3xl underline font-semibold mt-6'>Passion for Coding</p>
            <p className='text-white text-xl my-2'>What drives me in the world of web development is the ability to turn ideas into reality through code. I am passionate about creating user-friendly interfaces and solving problems with creative solutions. Every line of code I write is a step towards building a better digital experience.</p>
            <p className='text-white text-3xl underline font-semibold mt-6'>Learning Journey</p>
            <p className='text-white text-xl my-2'>As an entry-level developer, I am committed to continuous learning. I actively seek out opportunities to expand my skill set through online courses, tutorials, and hands-on projects. I am eager to delve deeper into both front-end and back-end development to broaden my understanding of web development.</p>
