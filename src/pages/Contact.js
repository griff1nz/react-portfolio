...
function Contact() {
    return <div className='height85'>
        <h1 className='text-center my-4 text-5xl text-white font-semibold'>Contact Me</h1>
        <p className='text-center mb-2 text-white text-xl'>Fill out the form below if you want to get in touch with me!<br/>I look forward to connecting with you.</p>
        <ContactForm />
