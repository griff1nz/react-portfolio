...
function Contact() {
    ...
    initial={{ opacity: 0 }}
        ...
        <p className='text-center mb-2 text-color text-xl mx-2'>Fill out the form below if you want to get in touch with me!<br/>I look forward to connecting with you.</p>
        <ContactForm />
